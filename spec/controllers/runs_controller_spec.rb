...
describe RunsController do
  ...
  describe "#edit" do
    let(:response) { get(:edit, id: run.id36) }
  ...
  describe "#update" do
    context "category" do
      let(:response) { put(:update, id: run.id36, run: {category: FactoryGirl.create(:category).id}) }
  ...
  describe "#destroy" do
    let(:response) { delete(:destroy, id: run.id36) }
