...
class RunsController < ApplicationController
  ...
  def set_run
    ...
    gon.run = {id: @run.id, id36: @run.id36, segments: @run.run_file.collapsed_segments}
  ...
  def set_comparison
    ...
    gon.comparison_run = {id: @comparison_run.id, id36: @comparison_run.id36, segments: @comparison_run.collapsed_segments}
