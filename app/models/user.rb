class User < ApplicationRecord
  ...
  has_many :twitch_follows,   class_name: 'User', through: :twitch_user_follows,   source: :to_user
  has_many :twitch_followers, class_name: 'User', through: :twitch_user_followers, source: :from_user
