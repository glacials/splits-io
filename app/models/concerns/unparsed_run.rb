    ...
    def parse_into_db
      with_lock do
        ...
        update(
          ...
          realtime_duration_ms:    massage(parse_result[:realtime_duration_ms]),
          realtime_sum_of_best_ms: massage(parse_result[:realtime_sum_of_best_ms]),

          gametime_duration_ms:    massage(parse_result[:gametime_duration_ms]),
          gametime_sum_of_best_ms: massage(parse_result[:gametime_sum_of_best_ms]),
    ...
    def write_segments(parsed_segments)
      ...
      parsed_segments.each do |parsed_segment|
        segs << Segment.new(
          ...
          realtime_start_ms:             massage(parsed_segment[:realtime_start_ms]),
          realtime_end_ms:               massage(parsed_segment[:realtime_end_ms]),
          realtime_duration_ms:          massage(parsed_segment[:realtime_duration_ms]),
          realtime_shortest_duration_ms: massage(parsed_segment[:realtime_best_ms]),

          realtime_skipped: parsed_segment[:realtime_skipped],
          realtime_reduced: false,
          realtime_gold:    parsed_segment[:realtime_gold],

          gametime_start_ms:             massage(parsed_segment[:gametime_start_ms]),
          gametime_end_ms:               massage(parsed_segment[:gametime_end_ms]),
          gametime_duration_ms:          massage(parsed_segment[:gametime_duration_ms]),
          gametime_shortest_duration_ms: massage(parsed_segment[:gametime_best_ms]),
